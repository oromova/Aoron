          ...
          <table className='min-w-full table-auto'>
            <thead>
              <tr className='bg-gray-200'>
                ...
                <th className='border border-gray-300 p-2'>Question ENG</th>
                <th className='border border-gray-300 p-2'>Answer (EN)</th>
                <th className='border border-gray-300 p-2'>Question RU</th>
                <th className='border border-gray-300 p-2'>Answer (RU)</th>
                <th className='border border-gray-300 p-2'>Question DE</th>
                <th className='border border-gray-300 p-2'>Answer (DE)</th>
